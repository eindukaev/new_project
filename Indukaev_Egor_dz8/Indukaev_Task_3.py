...
# Примечание:
# длина списка не фиксирована. Элементы запрашиваются бесконечно, пока пользователь сам не остановит
...
while a != 'stop':
    ...
    try:
        ...
        if a.isdigit():
            ...
            raise ElNumber('Тип данных not integer')
    except ElNumber as err:
        print(err)
    finally:
        pass